...
Deze samenvatting is hoogstwaarschijnlijk niet foutloos. Eventuele aanpassingen kunnen gemaakt worden op.\\* %TODO fix github
...
Deze samenvatting is vrijgegeven onder de beerware license. This resume is released under the beerware license. Donaties op onderstaand bitcoin adres worden altijd geapprecieerd.\\\\
\textit{"Alles moet zo eenvoudig mogelijk gemaakt worden, maar niet eenvoudiger dan dat."} - Albert Einstein\\\\
\begin{center}
\includegraphics[scale=0.1]{BitcoinAddress.png}\\*
